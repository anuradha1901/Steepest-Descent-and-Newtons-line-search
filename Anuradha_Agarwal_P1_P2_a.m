...
% We are trying the find the minimum value of this function —> where the tolerance of the function value is 1.0e-08
...
while norm(rb_func(x)) > tolerance && iteration < max_iterations % not to exceed the max iterations and reaching the tolerance level
